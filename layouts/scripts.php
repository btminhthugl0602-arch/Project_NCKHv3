...
<?php if (isset($pageJs)): ?>
    <script
        src="<?php echo $basePath; ?>/assets/js/<?php echo $pageJs; ?>?v=<?php echo filemtime(__DIR__ . '/../assets/js/' . $pageJs) ?: time(); ?>">
    </script>
<?php endif; ?>

<!-- Navbar Search (global — load on every page) -->
<?php $navSearchFile = __DIR__ . '/../assets/js/navbar-search.js'; ?>
<script src="<?php echo $basePath; ?>/assets/js/navbar-search.js?v=<?php echo filemtime($navSearchFile) ?: time(); ?>">
</script>
