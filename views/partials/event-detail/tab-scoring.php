...
<div id="subcommitteesTab">
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-3 mb-6">
        <div class="relative flex items-center gap-4 p-4 bg-white border-0 shadow-soft-xl rounded-2xl">
            <div class="flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-tl from-emerald-600 to-teal-400 shadow-soft-md text-white flex-shrink-0">
