...
$allowedTabs = [
    'overview',
    'config-basic', 'config-rules', 'config-criteria',
    'submissions', 'review-assign', 'review-results',
    'scoring', 'subcommittees', 'committees', 'judges',
];
...
// JS riêng theo tab — mặc định dùng event-detail.js
$tabJs = [
    'scoring' => 'scoring.js',
];
$pageJs = $tabJs[$tab] ?? 'event-detail.js';
